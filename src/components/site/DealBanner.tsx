...
export function DealBanner() {
  ...
  return (
    <div className="bg-deep-charcoal text-canvas-white">
      <div className="mx-auto flex w-full max-w-[1440px] flex-wrap items-center justify-center gap-x-3 gap-y-1 px-5 py-2.5 text-center lg:px-16">
        ...
        <span className="hidden text-canvas-white/40 sm:inline">·</span>
        <span className="font-[var(--font-label)] text-[11px] uppercase tracking-[0.1em] font-semibold text-canvas-white/80">
          Ends in
        </span>
        <span className="flex items-center gap-1 font-[var(--font-display)] text-[13px] font-semibold tabular-nums">
          ...
          <span className="text-canvas-white/60">:</span>
